...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        ...
        description: `Cập nhật tỷ giá USDT hôm nay ${new Date().toLocaleDateString('vi-VN')}. Giá mua: ${new Intl.NumberFormat('vi-VN').format(rate.sell)} VND, Giá bán: ${new Intl.NumberFormat('vi-VN').format(rate.buy)} VND. So sánh giá USDT trên Binance, Remitano, Onus.`,
        openGraph: {
